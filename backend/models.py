...
class Donation(Base):
    ...
    donation_type = Column(String, nullable=False)       # Money / Food / Supplies / Medicine / Other
    quantity = Column(Integer, nullable=True)            # Amount or count
    item_details = Column(String, nullable=True)         # Details e.g. "Rice bags", "Blankets"
