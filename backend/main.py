...
import models
from routers import alerts, camps, disaster, volunteers, resources, stats, admin, auth, weather, chat, donations
...
import asyncio
from gdacs_integration import start_gdacs_polling

@app.on_event("startup")
async def startup_event():
    asyncio.create_task(start_gdacs_polling())
